...
import { FaClock, FaBook, FaArrowRight } from 'react-icons/fa';
  ...
  const fallbackCourses = [
    {
      ...
      description:
        'Start your German journey with our comprehensive A1 course for absolute beginners.',
      level: 'a1',
      duration: '8 weeks',
      students: 120,
      lessons: 24,
      image:
        'https://images.pexels.com/photos/6146929/pexels-photo-6146929.jpeg?auto=compress&cs=tinysrgb&w=800',
      price: '70,000',
    },
    {
      id: 'a2-elementary',
      ...
      description:
        'Build upon your basic German skills and gain more confidence in everyday situations.',
      level: 'a2',
      duration: '10 weeks',
      students: 85,
      lessons: 30,
    ...
    },
    {
      ...
      description:
        'Advance your German skills to an intermediate level with this comprehensive course.',
      level: 'b1',
      duration: '12 weeks',
      students: 65,
      lessons: 36,
    ...
    },
    {
      ...
      description:
        'Master professional German communication for workplace success.',
      level: 'b2',
      duration: '16 weeks',
      students: 40,
      lessons: 48,
      ...
      <div className="container">
        <div className="text-center mb-12">
          ...
          <p className="text-neutral-600 max-w-2xl mx-auto">
            Discover our most popular German language courses designed to help
            you achieve fluency at your own pace with expert instruction.
          </p>
        </div>
