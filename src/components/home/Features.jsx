...
function Features() {
  ...
  return (
    ...
    <motion.div 
  key={index} 
  className="group bg-black text-white backdrop-blur-md rounded-xl border border-white/10 p-6 border-neutral-100 
...
>
    ...
    <h3 className="text-xl font-semibold mb-2 text-yellow-700">{feature.title}</h3>
